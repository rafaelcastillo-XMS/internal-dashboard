...
import { DATE_PRESETS } from '../hooks/useSEMDashboardState'
import { exportPageToPdf } from '@/features/seo/lib/exportPdf'

interface SelectOption { value: string; label: string }

interface SEMDashboardControlsProps {
...
export function DashboardControls({
  ...
  loading, onRefresh,
  pageTitle = 'SEM-Dashboard',
}: SEMDashboardControlsProps) {
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none rounded-lg border border-stroke bg-white
                       ...
                       transition-colors hover:border-[#16a34a] focus:border-[#16a34a]
