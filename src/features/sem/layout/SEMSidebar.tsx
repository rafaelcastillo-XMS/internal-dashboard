        ...
        <div className="border-t border-slate-200/70 px-4 py-3 dark:border-white/10">
          <Link
            ...
            className={`flex w-full items-center gap-3 rounded-lg px-3 py-2.5
                       ...
                       ${location.pathname === '/sem/reports'
                         ? 'bg-[#15803D] text-white border-[#15803D] shadow-sm dark:bg-[#16A34A] dark:border-[#16A34A]'
                         : 'border-transparent text-[var(--sidebar-item-text)] hover:bg-[var(--sidebar-item-hover)] hover:text-[var(--text-primary)]'
                       }`}
          >
